...
date: 'May 27, 2022'
summary: 'This tutorial will help you to extract information and data from the good old trusty Wikipedia using the Python programming language.'
cover_image: '/images/posts/img2.jpg'
ogdesc: 'This tutorial will help you to extract information and data from the good old trusty Wikipedia using the Python programming language.'
tags: ['python', 'tutorials']
ogtitle: 'Extract Info from wikipedia using python'
ogurl: 'https://techwithspandy.tk/blog/I-created-my-own-portfolio-using-tailwind-css'
ogkey: 'Web scraping, Python scraping, web, wikipedia, ptyhon web scraping'
keywords: 'Web scraping, Python scraping, web, wikipedia, python web scraping'
